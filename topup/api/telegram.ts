...
const supabaseUrl = process.env.VITE_SUPABASE_URL || 'https://izpyubrxnhutasfvylfc.supabase.co';
const supabaseKey = process.env.VITE_SUPABASE_ANON_KEY || 'sb_publishable_QmUlOoSp3CNDvL1_tm9qSw_BhN7i1gb';
